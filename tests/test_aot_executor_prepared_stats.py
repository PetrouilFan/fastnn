...
def test_prepared_stats_has_arena_keys():
    ...
    for key in (
        ...
        "transposed_fp32_conv_bindings",
        "transposed_fp32_conv_binding_flops",
    ):
    ...
    assert stats["transposed_fp32_conv_bindings"] == 0
    assert stats["transposed_fp32_conv_binding_flops"] == 0
