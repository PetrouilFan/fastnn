...
def test_relu_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.nn.functional.relu, x)
...
def test_sigmoid_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.sigmoid, x)
...
def test_gelu_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.nn.functional.gelu, x)
...
def test_sum_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.sum, x, 1)
...
def test_mean_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.mean, x, 1)
...
def test_max_torch(benchmark, size):
    x = torch.rand(size)
    result = benchmark(torch.max, x, 1)
