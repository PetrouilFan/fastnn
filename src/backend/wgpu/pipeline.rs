...
///   2: params (uniform)
build_pipeline!(ensure_simple_compute_pipeline, "wgpu_simple_", [
    wgpu::BindGroupLayoutEntry {
        binding: 0,
        visibility: wgpu::ShaderStages::COMPUTE,
        ty: wgpu::BindingType::Buffer {
...
build_pipeline!(ensure_matmul_activation_pipeline, "wgpu_backend_", [
    wgpu::BindGroupLayoutEntry {
        binding: 0,
        visibility: wgpu::ShaderStages::COMPUTE,
        ty: wgpu::BindingType::Buffer {
...
///   5: params        (uniform)
build_pipeline!(ensure_quantized_compute_pipeline, "wgpu_backend_quantized_", [
    wgpu::BindGroupLayoutEntry {
        binding: 0,
        visibility: wgpu::ShaderStages::COMPUTE,
        ty: wgpu::BindingType::Buffer {
